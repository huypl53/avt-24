...
classes = ("ship",)
data_root = "/workspace/data/SARscope"
# -----------------------------------------------------
...
cfg.train_dataloader.dataset.ann_file = (
    "/workspace/data/SARscope/train/_annotations.coco.json"
)
...
cfg.val_dataloader.dataset.ann_file = (
    "/workspace/data/SARscope/valid/_annotations.coco.json"
)
...
cfg.test_dataloader.dataset.ann_file = (
    "/workspace/data/SARscope/test/_annotations.coco.json"
)
...
cfg.val_evaluator.ann_file = "/workspace/data/SARscope/valid/_annotations.coco.json"
# cfg.val_evaluator.metric=['segm']

cfg.test_evaluator.type = "CocoMetric"
cfg.test_evaluator.ann_file = "/workspace/data/SARscope/test/_annotations.coco.json"
...
config = f"configs/atss/sar_{base}_{width}_{height}.py"
